...
% Calcolo di tutti gli indici tramite la funzione corrNominal dell'FSDA toolbox partendo dalla matrice dei dati (senza passare attravero il calcolo della tabella di contingenza)
